        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="font-display text-2xl mt-1 text-foreground">Painel Contábil (Visão do Contador)</h1>
          ...
          <label className="w-full max-w-md">
            ...
            <select
              ...
              className="w-full rounded-xl border border-border bg-card px-4 py-3 text-base text-foreground outline-none transition focus:border-primary/60 focus:ring-2 focus:ring-primary/25"
            >
      ...
      <section className="premium-card rounded-2xl p-5">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h2 className="font-display text-xl mt-1 text-foreground">Base de conferência contábil</h2>
