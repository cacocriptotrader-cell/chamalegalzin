...
const conciergeWhatsAppFeature = "Assistente IA via WhatsApp (Lançamentos por Áudio e Texto ilimitados)";
...
const tiers = [
  ...
  },
  {
    ...
    price: "R$ 149",
    period: "/mês",
    description: "A rotina completa para quem quer capturar, revisar e fechar o mês sem planilhas paralelas.",
    cta: "Ativar Pro",
    icon: Crown,
    highlighted: true,
...
function PricingPage() {
  return (
    <main className="min-h-screen bg-background text-foreground">
      <header className="border-b border-border/80 bg-background/88 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="hidden border-l border-border pl-2 text-[10px] uppercase tracking-[0.18em] text-muted-foreground sm:inline">
              Planos
            </span>
          </Link>
          <Link
            to="/login"
            className="inline-flex min-h-10 items-center justify-center rounded-xl border border-border px-4 text-sm font-semibold text-muted-foreground transition hover:border-primary/45 hover:text-primary"
          >
            Entrar
          </Link>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-5 py-6 sm:px-8 md:py-8">
            ...
            >
              ...
              <ul className="mt-6 flex-1 space-y-3">
                {tier.features.map((feature) => {
                  const isConciergeAnchor = tier.concierge && feature === conciergeWhatsAppFeature;
                  ...
                  return (
                    <li
                      ...
                      className={`flex gap-3 text-sm leading-6 ${
                        isConciergeAnchor
                          ? "rounded-xl border border-primary/30 bg-primary/10 px-3 py-2 font-semibold text-primary"
