...
export const DIRPF_PARSER_VERSION = "dirpf-parser-legacy-worker-2026-05-16-03";
...
export async function parseDirpfPdf(file: File): Promise<ParsedDirpfPatrimony> {
  try {
    ...
    try {
      ...
      console.error("[DIRPF PDF] Falha ao carregar documento PDF com worker legacy", error);
