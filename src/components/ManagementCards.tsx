  ...
  return (
    <Section title="Alertas Críticos" subtitle="Documentos vencidos, vencendo hoje ou próximos de vencer">
      <div className="grid gap-3 md:grid-cols-3">
        <div className="rounded-2xl border border-white/[0.06] bg-white/[0.035] p-4 shadow-sm md:col-span-3">
          ...
          {criticalDocs.length > 0 && (
            <div className="mt-3 grid gap-2 md:grid-cols-2">
              {criticalDocs.slice(0, 4).map((doc) => (
                <div key={doc.id} className="flex items-center justify-between gap-2 rounded-xl border border-white/[0.06] bg-black/20 px-3 py-2 text-[11px]">
