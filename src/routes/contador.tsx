        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <h1 className="font-display text-2xl mt-1">Painel Contábil (Visão do Contador)</h1>
          ...
          <label className="w-full max-w-md">
            ...
            <select
              ...
              className="w-full rounded-xl border border-border bg-card px-4 py-3 text-base text-foreground outline-none transition focus:border-primary/60 focus:ring-2 focus:ring-primary/20"
            >
      ...
      <section className="premium-card rounded-2xl p-5">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h2 className="font-display text-xl mt-1">Base de conferência contábil</h2>
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <button
              type="button"
              onClick={generateOfx}
              className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-border px-4 py-2.5 text-sm font-semibold text-muted-foreground transition hover:border-primary/40 hover:text-primary"
            >
        ...
        <div className="mt-4 overflow-x-auto rounded-xl border border-border">
          <table className="min-w-[760px] w-full text-left text-sm">
            <thead className="bg-surface-elevated text-[10px] uppercase tracking-[0.16em] text-muted-foreground">
              <tr>
...
function ReadOnlyShiftRow({ shift }: { shift: Shift }) {
  ...
  return (
    <tr className="text-foreground/90">
      ...
      <td className="px-4 py-3 font-medium">{workplace?.name ?? "Hospital não cadastrado"}</td>
