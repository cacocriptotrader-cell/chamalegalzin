              ...
              <div className="overflow-x-auto">
                <div className="min-w-[760px] space-y-2">
                  ...
                  {draftAssets.map((asset) => (
                    <div key={asset.id} className="grid grid-cols-[1fr_170px] gap-3 rounded-2xl bg-black/20 border border-white/10 p-3 items-center">
              ...
              <div className="overflow-x-auto">
                <div className="min-w-[760px] space-y-2">
                  ...
                  {draftLiabilities.map((liability) => (
                    <div key={liability.id} className="grid grid-cols-[1fr_170px] gap-3 rounded-2xl bg-black/20 border border-white/10 p-3 items-center">
                      <div className="min-w-0">
                        <p className="text-[10px] uppercase tracking-[0.14em] text-muted-foreground mb-1">
