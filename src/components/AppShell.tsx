        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-10">
            <Link to={isAccountant ? "/contador" : "/dashboard"} className="flex items-center gap-2 group">
              ...
              <span className="rounded-full border border-border/70 bg-surface/70 px-2 py-0.5 text-[9px] uppercase tracking-[0.14em] text-muted-foreground/70 hidden lg:inline">
                {CACHE_BUSTER_DOCFIN}
              </span>
            </Link>
