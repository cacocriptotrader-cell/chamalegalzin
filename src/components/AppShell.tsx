        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-10">
            <Link to={isAccountant ? "/contador" : "/dashboard"} className="flex items-center gap-2 group">
              <div className="h-6 w-6 rounded-md bg-primary text-primary-foreground flex items-center justify-center shadow-[0_0_24px_rgba(6,182,212,0.28)]">
          ...
          <div className="flex items-center gap-3">
            ...
            {!isAccountant && (
              <button
                ...
                className="inline-flex items-center gap-1.5 h-8 px-3 rounded-md bg-primary text-primary-foreground text-xs font-semibold shadow-[0_0_24px_rgba(6,182,212,0.20)] transition-all duration-200 hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
              >
