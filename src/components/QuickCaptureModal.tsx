    ...
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="premium-modal fixed left-1/2 top-1/2 z-50 max-h-[calc(100vh-2rem)] w-[calc(100vw-32px)] max-w-lg -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-2xl p-0 backdrop-blur"
        >
          ...
          <div className="mt-5 space-y-4 px-5 pb-4 md:px-6">
          ...
          <div className="sticky bottom-0 z-10 border-t border-border bg-background/95 p-4 backdrop-blur md:px-6">
            <button
              type="button"
              onClick={saveDraft}
