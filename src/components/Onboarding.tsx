...
export function Onboarding() {
  ...
  async function finishOnboarding() {
    ...
    try {
      ...
      const normalizedSpecialty = specialtyName.trim() || "Ainda sem especialidade";
      ...
      if (error && (error.code === "PGRST204" || error.code === "42703" || /column|schema cache/i.test(error.message))) {
        logger.warn("Schema de perfil reduzido detectado. Tentando salvar onboarding com payload mínimo.", error);
