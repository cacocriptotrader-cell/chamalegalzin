      ...
      >
        ...
        {hasWealthData ? (
          ...
          <div className="mt-5">
            <Link
              to="/patrimonio"
              className="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground shadow-[0_0_24px_rgba(6,182,212,0.18)] transition hover:bg-primary/90"
            >
    ...
    >
      <div className="premium-panel rounded-2xl p-4">
        ...
        <button
          ...
          className="mt-4 w-full rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-primary-foreground shadow-[0_0_24px_rgba(6,182,212,0.18)] transition hover:bg-primary/90"
        >
