        ...
        >
          ...
          <div className="mt-5 space-y-4">
            ...
            <label className="space-y-1.5 block">
              ...
              {store.workplaces.length > 0 ? (
                ...
                <div className="rounded-2xl border border-dashed border-border bg-card p-4">
                  <p className="text-sm font-semibold text-foreground">Nenhum hospital cadastrado</p>
                  <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
                    Cadastre um hospital antes de lançar plantões. Isso define regime, prazos de pagamento e cálculo de recebíveis.
                  </p>
                </div>
              )}
            </label>
            <Link
              ...
              className="inline-flex min-h-11 w-full items-center justify-center rounded-xl border border-primary/35 bg-primary/10 px-4 py-2.5 text-sm font-semibold text-primary transition hover:bg-primary/15"
            >
              Cadastrar hospital
            </Link>
            ...
            <div className="premium-panel flex items-center justify-between rounded-xl px-3 py-2.5">
              ...
              <span className="font-mono text-sm text-success tabular-nums">{brl2(gross)}</span>
            </div>
