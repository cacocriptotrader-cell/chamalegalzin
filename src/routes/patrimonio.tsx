    ...
    <div className="px-5 py-4 space-y-6">
      ...
      <section className="grid gap-4 lg:grid-cols-[1.15fr_0.85fr] items-stretch">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(222,255,154,0.18), rgba(38,38,38,0.94) 48%, rgba(212,175,55,0.12))",
          }}
        >
        ...
        >
          <div className="flex flex-col items-center text-center gap-3">
            <div
              ...
              style={{ boxShadow: "0 18px 60px rgba(222,255,154,0.12)" }}
            >
              {analyzing ? (
              ...
              <>
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 mt-2">
                  <button
                    ...
                    className="px-5 py-2.5 rounded-xl text-sm font-medium inline-flex items-center gap-2 bg-primary text-primary-foreground hover:bg-primary/90 transition shadow-[0_16px_50px_rgba(222,255,154,0.14)]"
                  >
