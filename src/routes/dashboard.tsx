...
function MiniMetric({
  ...
  return (
    <div className={`premium-panel rounded-xl px-3 py-2.5 ${strong ? "border-success/30 bg-success/10" : ""}`}>
      <p className="text-[10px] uppercase tracking-wider text-muted-foreground">{label}</p>
      <p className={`font-mono ${strong ? "text-base" : "text-sm"} font-semibold mt-1 tabular-nums ${tone === "success" ? "text-success" : tone === "danger" ? "text-destructive" : "text-foreground"}`}>
        {value}
      </p>
    </div>
  );
