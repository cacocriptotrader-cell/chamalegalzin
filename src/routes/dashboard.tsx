            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <label className="flex flex-col gap-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-muted-foreground sm:min-w-[220px]">
                ...
                <select
                  ...
                  className="rounded-lg border border-border bg-card px-3 py-2 text-xs normal-case tracking-normal text-foreground outline-none transition focus:border-primary/60 focus:ring-2 focus:ring-primary/20"
                >
