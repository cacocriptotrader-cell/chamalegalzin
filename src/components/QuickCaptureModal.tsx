...
export function QuickCaptureModal({ open, onOpenChange, prefill }: QuickCaptureModalProps) {
  ...
  function saveDraft() {
    ...
    toast.success("Rascunho salvo no Inbox.");
    onOpenChange(false);
  }
  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="premium-modal fixed left-1/2 top-1/2 z-50 w-[calc(100vw-32px)] max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-xl p-5 backdrop-blur md:p-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <Dialog.Title className="font-display text-xl">Captura rápida</Dialog.Title>
          ...
          <div className="mt-5 space-y-4">
            ...
            <button
              ...
              className="w-full rounded-xl bg-primary px-4 py-3 text-sm font-semibold text-primary-foreground hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-40 transition"
            >
