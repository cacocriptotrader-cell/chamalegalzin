...
import { Mail, Lock, ArrowRight, Loader2, Calculator, Stethoscope } from "lucide-react";
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      if (mode === "login") {
        ...
        window.sessionStorage.setItem("docfin.pendingRole", selectedRole);
      ...
      // Após login, redireciona para o portal; OnboardingGate decide
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="h-12 w-full rounded-xl border border-border bg-card px-4 text-base transition-colors focus:border-primary/50 focus:outline-none"
            />
          </div>
