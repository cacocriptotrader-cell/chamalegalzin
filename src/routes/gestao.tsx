      ...
      <div className="grid gap-3 md:grid-cols-3">
        {hubCards.map(({ to, title, subtitle, icon: Icon }) => (
          <Link
            key={to}
            to={to}
            className="group rounded-2xl border border-border bg-card/80 p-5 hover:bg-secondary/70 transition"
          >
    ...
    <section className="rounded-2xl border border-border bg-card/80 p-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="max-w-2xl">
          ...
          <h2 className="font-display text-lg mt-2">Acesso do contador</h2>
        ...
        {hasActiveAccess ? (
          <div className="w-full max-w-md rounded-xl border border-primary/25 bg-primary/10 p-4">
          ...
          <div className="w-full max-w-md">
            <label className="block">
              ...
              <input
                ...
                className="w-full rounded-xl border border-border bg-card px-4 py-3 text-base text-foreground outline-none transition placeholder:text-muted-foreground focus:border-primary/60 focus:ring-2 focus:ring-primary/20"
              />
            </label>
            <button
              type="button"
