    ...
    <header className="sticky top-0 z-50 border-b border-[#1A2332]/80 bg-black/62 backdrop-blur-2xl">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 md:px-8">
        <Link to="/" className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-emerald-500/25 bg-emerald-500/10 text-emerald-300 shadow-[0_0_42px_rgba(15,118,110,0.22)]">
            <Command className="h-4.5 w-4.5" strokeWidth={2.5} />
          </div>
          <div>
            <p className="text-base font-semibold tracking-tight text-gray-100">DocFin</p>
      ...
      <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-[1.35fr_0.8fr_0.8fr_0.8fr]">
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-gray-100">DocFin</p>
              <p className="text-[10px] font-bold uppercase tracking-[0.24em] text-gray-500">Gestão Médica Premium</p>
            </div>
          </div>
