...
function DraftShiftRow({
  ...
  return (
    <div
      className={`rounded-2xl border p-4 text-left transition ${active ? "border-primary/45 bg-primary/10" : "premium-panel hover:border-primary/30"} ${syncing || deleting ? "opacity-60" : ""}`}
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <button
            ...
            onClick={onDelete}
            disabled={deleting}
            className="inline-flex min-h-10 items-center justify-center gap-1.5 rounded-xl border border-destructive/35 bg-destructive/10 px-3 text-xs font-semibold text-destructive transition hover:border-destructive/60 hover:bg-destructive/15 disabled:cursor-wait disabled:opacity-60"
    ...
    >
      ...
      <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:justify-end">
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-xl border border-destructive/35 bg-destructive/10 px-4 py-2.5 text-sm font-semibold text-destructive transition hover:border-destructive/60 hover:bg-destructive/15 disabled:cursor-wait disabled:opacity-60"
        >
          <Trash2 className="h-4 w-4" />
